...
function Welcome()
{
  return (
    ...
    >
      <h4
      className="text-5xl sm:text-3xl md:text-3xl xl:text-5xl text-center font-bold text-layer-dark-900 dark:text-layer-light-50 transition-all duration-500">
        Hizmetin Yeni Adresi
      </h4>
      <div 
      className="card relative inline-block justify-content-center my-5">
      <Search />
      </div>
